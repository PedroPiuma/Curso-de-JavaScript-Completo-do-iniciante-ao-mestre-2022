; (function () {
    ...
    function Task(name, completed, createdAt, updatedAt) {
        ...
        // this.changeCompleted = value => this.completed = value

    }
    // const teste = new Task('Luís', true)
    // console.log(teste)

    // const teste2 = new Task('Minha segunda tarefa')
    // console.log(teste2)
    // teste2.changeName('Tarefa renomeada')
    // console.log(teste2)
    ...
    const arrInstancesTasks = arrTasks.map(el => new Task(el.name, el.completed, el.createdAt, el.updatedAt))
